...
;;;;; lsp-ui
  ...
  (lsp-headerline-breadcrumb-symbols-face ((t (:foreground base2 :weight 'bold))))
;;;;; lusty-explorer
...
;;;;; org-mode
     ...
     (org-block nil)
     (org-block-begin-line (:inherit 'org-meta-line :underline 'unspecified))
     (org-block-end-line (:inherit 'org-meta-line :overline 'unspecified))
