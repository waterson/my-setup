;;; derpy-hooves-theme.el --- Low-contrast Zenburn-inverted theme

;; Author: Andrey Kotlarski <m00naticus@gmail.com>
;; URL: https://github.com/m00natic/derpy-hooves-theme
;; Version: 2.4
...
(deftheme derpy-hooves "Reversed Zenburn color theme.")
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(warning ((t (:foreground ,azenburn-burnt-orange :weight bold))))
   ...
   `(compilation-warning-face ((t (:foreground ,azenburn-burnt-orange :weight bold :underline t))))
...
;;; faces used by isearch
   ...
   `(font-lock-warning-face ((t (:foreground ,azenburn-burnt-orange :weight bold))))
...
;;; android mode
   ...
   `(android-mode-warning-face ((t (:foreground ,azenburn-burnt-orange))))
...
;;; flycheck
   `(flycheck-error
     ((((supports :underline (:style wave)))
       (:underline (:style wave :color ,azenburn-red) :inherit unspecified))
      (t (:foreground ,azenburn-red :weight bold :underline t))))
   `(flycheck-warning
     ((((supports :underline (:style wave)))
       (:underline (:style wave :color ,azenburn-burnt-orange) :inherit unspecified))
      (t (:foreground ,azenburn-burnt-orange :weight bold :underline t))))
   `(flycheck-info
     ((((supports :underline (:style wave)))
...
;;; flymake
   `(flymake-errline
     ((((supports :underline (:style wave)))
       (:underline (:style wave :color ,azenburn-red)
                   :inherit unspecified :foreground unspecified :background unspecified))
      (t (:foreground ,azenburn-red :weight bold :underline t))))
   `(flymake-warnline
     ((((supports :underline (:style wave)))
       (:underline (:style wave :color ,azenburn-burnt-orange)
                   :inherit unspecified :foreground unspecified :background unspecified))
      (t (:foreground ,azenburn-burnt-orange :weight bold :underline t))))
   `(flymake-infoline
     ((((supports :underline (:style wave)))
...
;;; js2-mode
   `(js2-warning ((t (:underline ,azenburn-burnt-orange))))
...
;;; mew
   ...
   `(mew-face-header-warning ((t (:foreground ,azenburn-burnt-orange))))
...
;;; org-mode
   ...
   `(org-warning ((t (:bold t :foreground ,azenburn-burnt-orange :weight bold :underline nil))))
...
;;; proofgeneral
   ...
   `(proof-warning-face ((t (:foreground ,azenburn-bg :background ,azenburn-burnt-orange))))
...
;;; smart-mode-line
   ;; use (setq sml/theme nil) to enable derpy-hooves for sml
...
;;; SLIME
   ...
   `(slime-warning-face
     ((((supports :underline (:style wave)))
       (:underline (:style wave :color ,azenburn-burnt-orange)))
      (t (:underline ,azenburn-burnt-orange))))
...
;;; term
   ...
   `(term-color-yellow ((t (:foreground ,azenburn-burnt-orange
...
;;; whitespace-mode
   ...
   `(whitespace-space-before-tab ((t (:background ,azenburn-burnt-orange :foreground ,azenburn-burnt-orange))))
...
(provide-theme 'derpy-hooves)

;;; derpy-hooves-theme.el ends here
