;;; pinkie-pie.el --- a pink color theme for Emacs
...
(custom-theme-set-faces
 ...
 ;; LSP
 '(lsp-headerline-breadcrumb-path-face ((t (:inherit header-line))))
 '(lsp-headerline-breadcrumb-symbols-face ((t (:foreground "linen" :weight bold))))
 '(lsp-headerline-breadcrumb-separator-face ((t (:foreground "hot pink"))))
 )
...
(custom-theme-set-variables
 ...
 '(rcirc-colors pinkie-pie-foreground-colors))

(defun pinkie-pie-save-or-open ()
...
(defvar pinkie-pie-foreground-colors
  (let ((candidates)
	;; (red-limit #xe000)
	(green-limit #xa000)
	(both-limit #xa000))
    (dolist (item color-name-rgb-alist)
      (seq-let [color red green blue] item
...
\(list-colors-display pinkie-pie-foreground-colors).")

(provide-theme 'pinkie-pie)

;;; pinkie-pie-theme.el ends here
