;;; lucky-clover-theme.el --- lucky-clover theme
...
;;; Commentary:
;;
;; Port of lucky-clover theme from `color-themes'

;;; Code:

(deftheme lucky-clover
  "lucky-clover theme")
...
(provide-theme 'lucky-clover)

;;; lucky-clover-theme.el ends here
